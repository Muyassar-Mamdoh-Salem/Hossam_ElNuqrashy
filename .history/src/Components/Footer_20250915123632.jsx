  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-10 pb-6 mt-10">
      ...
      <div className="mt-10 border-t border-gray-700 pt-4 text-center text-xs text-gray-400">
         ...
         <a className="text-blue-500" href="https://www.facebook.com/MuyassarMamdoh">Muyassar Mamdoh</a> <span className="text-red-500">2025 جميع الحقوق محفوظة </span>
