...
const AboutMe = () => {
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      <Helmet>
        <title>About Hossam | Professional Photographer</title>
        <meta
          name="description"
          content="Learn more about Hossam, a professional photographer with over 5 years of experience capturing weddings, portraits, and creative photoshoots. Discover his passion and journey."
        />
        <meta
          name="keywords"
          content="Hossam photographer, about Hossam, professional photographer, wedding photography, portrait photography, creative photoshoots"
        />
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-center">
          <img
            src="hossam.jpg"
            alt="Hossam Photographer Portrait"
